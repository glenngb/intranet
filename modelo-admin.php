...
if($_POST['registro'] == "nuevo" ){ //Si existe.
    $nivel = (int) $_POST['nivel']; //desactivar para que funcione la alerta al modificar
...
//Código para editar de los administradores
/*****************************************/
if($_POST['registro'] == "actualizar" ){ //Si existe.
    $id = $_POST['id_registro'];//desactivar para que funcione la alerta al ingresar
