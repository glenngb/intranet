        ...
        <form role="form" name="guardar-registro" id="guardar-registro" method="POST" action="modelo-admin.php"> 
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="password" class="form-control" id="contrasenia" name="contrasenia" autocomplete="off" placeholder="Ingresa una contraseña">
                    </div>

                    <div class="form-group">
                      <label for="contrasenia">Repetir contraseña:</label>
                      <input type="password" class="form-control" id="repetir_contrasenia" name="repetir_contrasenia" autocomplete="off" placeholder="Repita la contraseña">
