...
<?php $sql = "SELECT 
    ...
    IFNULL(locales.cantidad, 0) AS cantidad,
    IFNULL(margen_diario, 0) AS margen_diario,
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home-Ventas Acumuladas</a></li>
        ...
        <table class="display" id="mitabla" style="width:45%"> <!-- para el autofiltro de la tabla -->
					...
					<thead> <!-- Encabezado de la tabla -->
						<tr>
                            ...
                            <th><center>Margen Dia </center></th>
          ...
          <?php while ($row = $ventames->fetch_array(MYSQLI_ASSOC)) { ?>  <!-- Recorre todos los resultados de nuestra consulta -->
                ...
                <td><center><?php echo number_format($row['cantidad'], 0,'$', '.');?></center></td><!-- separador de miles --> 
                ...
                <td><center><?php echo number_format($row['margen_diario'], 0,'$', '.');?></center></td><!-- separador de miles --> 
                <td><center><?php echo round ($row['porcentaje_venta'],2);?></center></td>
            </tr>
            <?php } ?>
