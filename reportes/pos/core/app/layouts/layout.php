...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Punto de venta | Atarraya</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-lg"><b>Atarraya-</b>Tech</span>
        </a>
...
<div class="user-panel">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="./?view=#">Vendedores</a></li>
              </ul>
            </li>
    ...
    <?php endif;?>
      ...
      <div class="content">
        ...
        <strong>Copyright &copy; 2021 <a href="#" target="_blank">Glenn Garcia</a></strong>
      </footer>
      <?php else:?>
<div class="login-box">
      <div class="login-logo">
        <a href="./">Punto de venta <b>Atarraya</b></a>
      </div><!-- /.login-logo -->
